//! Connection Pooling with rocket_db_pools

use crate::Connection;
use hdbconnect_impl::{ConnectParams, HdbError, HdbResult, IntoConnectParams};

/// Implementation of rocket_db_pools'
/// [`Pool`](https://docs.rs/r2d2/*/r2d2/trait.ManageConnection.html)
/// https://api.rocket.rs/master/rocket_db_pools/trait.Pool.html
/// https://api.rocket.rs/v0.5-rc/rocket_db_pools/trait.Pool.html
///
/// interface.
///
/// # Example
