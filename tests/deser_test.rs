...
//
//
// use hdbconnect::{HdbResult, ResultSet};
// use hdbconnect::types::{Row, HdbValue};
// use hdbconnect::metadata::new_resultset_for_tests;
// use hdbconnect::metadata::{FieldMetadata, ResultSetMetadata};
//
...
//
//     let row = Row {
//         values: vec![HdbValue::N_VARCHAR(Some("1.50.000".to_string())),
//                      HdbValue::NVARCHAR("HalloDri".to_string()),
//                      HdbValue::INT(42)],
//     };
//     let rows = vec![row.clone(), row.clone(), row.clone()];
//
//     new_resultset_for_tests(rsm, rows)
// }
