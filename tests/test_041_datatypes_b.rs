...
fn write(
    ...
    stmt.execute(&(
        "Hello world!", "Hello world!", Bytes::new(&parse_hex("0123456789abcdef")), 
        false, "Hello world!", "Hello world!", 
        "2019-01-18 01:02:03.456789", "2019-01-18 01:02:03", "2019-01-18", "01:02:03" 
    ))?;
    ...
    stmt.execute(&(
        HdbValue::N_CLOB(None), HdbValue::N_NCLOB(None), HdbValue::N_BLOB(None),
        HdbValue::N_BOOLEAN(None), HdbValue::N_TEXT(None), HdbValue::N_SHORTTEXT(None),
        HdbValue::N_LONGDATE(None), HdbValue::N_SECONDDATE(None),
        HdbValue::N_DAYDATE(None), HdbValue::N_SECONDTIME(None)
    ))?;
    Ok(())
}
